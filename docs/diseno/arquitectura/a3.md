...
#### Herramientas de administración de contenidos del sistema
...
| Código  | Componente                       |
| ------- | -------------------------------- |
| A3-GTFS | Gestión de datos GTFS            |
| A3-CMS  | Sistema de gestión de contenidos |
| A3-SIM  |                                  |
| A3-DATA | Servidor para análisis de datos  |
| A3-MCP  | Protocolo de contexto de modelos |
