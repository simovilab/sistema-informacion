...
| Versión | 1.1 |
| Fecha | 2025-10-23 |
| Descripción | Un catálogo de las categorías de partes interesadas para el Sistema de Información del Transporte Público. |
...
- Descripción: Personas que utilizan el sistema de transporte público para sus desplazamientos diarios o necesidades de viaje.
- Rol: End Users
- Intereses: Información confiable y oportuna sobre llegadas y salidas de autobuses., Aplicación móvil fácil de usar para la planificación de rutas., Actualizaciones en tiempo real sobre interrupciones o retrasos del servicio.
- Influencia: High
- Prioridad: High
...
- Descripción: Empresas o entidades responsables de operar los autobuses dentro del sistema de transporte público.
- Rol: Service Providers
- Intereses: Programación y despacho eficiente de autobuses., Acceso a datos en tiempo real para una mejor gestión de la flota., Integración con sistemas de pago para la recaudación de tarifas.
- Influencia: High
- Prioridad: High
...
- Rol: Support Staff
- Intereses: Acceso a cronogramas y registros de mantenimiento., Alertas en tiempo real sobre problemas o averías de vehículos., Comunicación eficiente con las operadoras de autobuses.
- Influencia: Medium
- Prioridad: Medium
...
- Intereses: Proporcionar supervisión técnica independiente y basada en datos., Influir en la política pública con investigación basada en evidencia., Utilizar datos de movilidad para crear y validar modelos de desarrollo urbano.
- Influencia: Medium
- Prioridad: Medium
