...
- Un conjunto de principios de diseño basados en tendencias internacionales de desarrollo de sistemas inteligentes de transporte público y sistemas informáticos en general proveen una base sólida para tomar decisiones de la arquitectura tecnológica.
- La investigación del contexto costarricense también permite conocer las necesidades locales y ajustar los requisitos del sistema.
- Esta sección presenta una recopilación de principios relevantes para el sistema propuesto, surgidos de nuestra propia investigación, de agencias relacionadas con el transporte público, organizaciones transnacionales, consorcios industriales, antecedentes en Costa Rica, legislación relevante y otras fuentes.
